...
<div class="container-fluid generic-container container-contact">
    <div class="row fancy-background">
        <div class="col-sm-8">
            <h2>LEARN MORE ABOUT<br> OUR CONSTRUCTION </h2>
            <p>Emeran system's team can provide the experience(Consultants), expertise(Construction Engineers), resourses(ERP systems) and materials you need. </p>
        </div>
        <div class="col-sm-4">
